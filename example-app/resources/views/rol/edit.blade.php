...
<form class="row g-3">
  ...
  <div class="col-6">
    ...
    <input type="text" class="form-control" id="inputAddress" value="Raziel">
  </div>
  <div class="col-6">
    <label for="inputAddress2" class="form-label">Apellido Paterno</label>
    <input type="text" class="form-control" id="inputAddress2" value="Hernandez">
  </div>
  <div class="col-6">
    <label for="inputAddress2" class="form-label">Apellido Materno</label>
    <input type="text" class="form-control" id="inputAddress2" value="Ramirez">
  </div>
  <div class="col-md-6">
